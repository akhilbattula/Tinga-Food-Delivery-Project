 ...
 */
public class NonvegItemsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nonveg_items, container, false);

        Bundle b = getArguments();
        restaurant_id = b.getString("rid");
        recycler = view.findViewById(R.id.nonvegitems_recycler);
    ...
    public void addContent(int i,String rid){
        ...
        tingaManager.getFoodItems(getActivity(), rid, "NON-VEG", i, new TingaManager.FoodCallBack() {
            @Override
