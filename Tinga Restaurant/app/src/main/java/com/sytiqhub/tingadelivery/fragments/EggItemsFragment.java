 ...
 */
public class EggItemsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_egg_items, container, false);

        Bundle b = getArguments();
        restaurant_id = b.getString("rid");
        recycler = view.findViewById(R.id.eggitems_recycler);
    ...
    public void addContent(int i,String rid){
        ...
        tingaManager.getFoodItems(getActivity(), rid, "EGG", i, new TingaManager.FoodCallBack() {
            @Override
