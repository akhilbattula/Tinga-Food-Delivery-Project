            ...
            public void onSuccess(List<OrderBean> detailsMovies) {
                ...
                if(ITEMS.size()<=0){
                    ...
                    for(int i = 0;i<ITEMS.size();i++){
                        ...
                        if((ITEMS.get(i).getStatus().equalsIgnoreCase("Accepted_Delivery"))
                        ||(ITEMS.get(i).getStatus().equalsIgnoreCase("Ready_Restaurant"))
                        ||(ITEMS.get(i).getStatus().equalsIgnoreCase("Collected_Delivery"))){
