...
public class OrdersTabFragment extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        newOrdersFragment.setArguments(bundle1);
        ...
        activeOrdersFragment.setArguments(bundle2);

        adapter.addFragment(newOrdersFragment, "New Orders");
        adapter.addFragment(activeOrdersFragment, "Active Orders");
