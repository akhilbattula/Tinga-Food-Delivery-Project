...
import com.sytiqhub.tingadelivery.fragments.PreviousOrdersTabFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("akhillll",preferenceManager.getDeliveryDetails().getId());
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            Log.d("akhillll",pref.getDeliveryDetails().getId());
            ...
            switch (position) {
                case 0:
                    ...
                    return tab1;
                case 1:
                    PreviousOrdersTabFragment tab2 = new PreviousOrdersTabFragment();
                ...
                case 2:
                    ...
                    bundle3.putString("rid",pref.getDeliveryDetails().getId());
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        tingaManager.getDeliveryDetails(MainActivity.this, preferenceManager.getDeliveryDetails().getId(), 1, new TingaManager.DeliveryCallBack() {
            @Override
            public void onSuccess(DeliveryBean deliveryBean) {

                if(deliveryBean.getStatus().equals("Available")){
        ...
        switchAB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    tingaManager.ChangeDeliveryStatus(MainActivity.this, preferenceManager.getDeliveryDetails().getId(), "Available", new TingaManager.DeliveryStatusCallBack() {
                        @Override
                    ...
                    tingaManager.ChangeDeliveryStatus(MainActivity.this, preferenceManager.getDeliveryDetails().getId(), "Unavailable", new TingaManager.DeliveryStatusCallBack() {
                        @Override
                        public void onSuccess(String food_id) {
    ...
    public void onStart() {
        ...
        String[] permissions = {Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION};
